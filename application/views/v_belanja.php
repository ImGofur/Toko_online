            ...
            <ul class="dropdown-menu">
			  ...
			  <?php foreach ($keranjang as $key => $value) {?>
                <div class="cart-item product-summary">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="detail.html"><img src="<?= base_url()?>template/Marazzo/assets/images/products/p4.jpg" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
                      <h3 class="name"><a href="index8a95.html?page-detail"><?= $value['name']?></a></h3>
                      <div class="price"><?= $value['qty']?>x</span>Rp.<?= number_format($value['price'],0)?></div>
                    </div>
...
<div class="body-content outer-top-xs">
    ...
    <p class=" pull-right outer-right-xs"><?php echo form_submit('', 'Update your Cart'); ?></p>
	...
	<table class="table">
      ...
      <th>
					...
					<div class="cart-grand-total">
						Grand Total<span class="inner-left-md">$<?php echo $this->cart->format_number($this->cart->total()); ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
